# Graph Report - metro-launcher  (2026-09-23)

## Corpus Check
- 39 files · ~26,321 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 13 file(s) not represented in the graph (top: .ttf 6, .xml 2, .properties 2)

## Summary
- 518 nodes · 1433 edges · 34 communities (17 shown, 17 thin omitted)
...
Cohesion: 0.06
Nodes (104): Alignment, animatable, animatedvisibility, Row, AppRow(), DrawerScreen(), JumpGrid(), Color (+96 more)
...
Cohesion: 0.13
Nodes (19): androidx, Color, Dp, MetroDefaults, MetroDimens, MetroScheme, MetroTheme(), metroTypography() (+11 more)
...
### Community 7 - "TileDragResizeTest"
Cohesion: 0.35
Nodes (3): TileDragResizeTest, tileTag(), Offset

### Community 8 - "AppIconLoader"
Cohesion: 0.10
Nodes (23): AppIconLoader, AppWidgetProviderInfo, StateFlow, LoadedApp, LoadedWidgetApp, AppInfo, StateFlow, asimagebitmap (+15 more)

### Community 9 - "WeatherTile.kt"
Cohesion: 0.07
Nodes (43): City, Data, DayPoint, Error, HourPoint, Flow, JSONObject, Loading (+35 more)
...
### Community 23 - "ClockTile.kt"
Cohesion: 0.18
Nodes (16): animatefloatasstate, CalendarFace(), ClockFace(), ClockTile(), getMonthGridData(), Dp, Modifier, MonthGridData (+8 more)

### Community 25 - "AndroidWidgetTile"
Cohesion: 0.28
Nodes (7): AndroidWidgetTile(), InterceptingWidgetContainer, android, AppWidgetHost, AppWidgetManager, Modifier, FrameLayout
...
- **Why does `HomeTileItem` connect `HomeTileItem` to `DrawerScreen.kt`, `MainActivity.kt`, `HomeViewModel`, `TileDragResizeTest`, `WeatherTile.kt`, `AndroidWidgetTile`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `WallpaperRepository` connect `WallpaperRepository` to `AppIconLoader`, `MainActivity.kt`, `TileDragResizeTest`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `AppIconLoader` connect `AppIconLoader` to `DrawerScreen.kt`, `WeatherTile.kt`?**
...
- **Should `DrawerScreen.kt` be split into smaller, more focused modules?**
  _Cohesion score 0.060418508694370765 - nodes in this community are weakly interconnected._
...
- **Should `MetroTheme.kt` be split into smaller, more focused modules?**
